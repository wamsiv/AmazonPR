...
with open("completeu1.csv", "w",newline = '') as file:
	...
	for item in json_list:
		...
		csv_file.writerow([item['reviewerID'],item['asin'],name,helpf,item['reviewText'],summ,item['overall'],date_new,date_r,mon_year,mon,year])
